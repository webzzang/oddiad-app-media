...
public class ActivitySplashBindingImpl extends ActivitySplashBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.noti_zone, 1);
        sViewsWithIds.put(R.id.device_id_text, 2);
        sViewsWithIds.put(R.id.device_noti, 3);
        sViewsWithIds.put(R.id.loading_zone, 4);
        sViewsWithIds.put(R.id.bi_view, 5);
        sViewsWithIds.put(R.id.bi_pro, 6);
        sViewsWithIds.put(R.id.bi_text_1, 7);
        sViewsWithIds.put(R.id.bi_text_2, 8);
    }
    // views
    @NonNull
